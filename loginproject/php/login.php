<html>
	...
	<body>
		<div class="container">
			<form action="http://localhost:1234/loginproject/php/login.php" method="post">
				...
				<span class="two"><a href="http://localhost:1234/loginproject/newuser.html">New User</a></span>
			</form>
		</div>
		<?php
		...
		if(isset($_POST['submit'])) {
			...
			if(empty($data_missing)) {
				...
				if(password_verify($password, $fetch[1])) {
					header("Location: http://localhost:1234/loginproject/php/loggedin.php?username=$username");
				}
